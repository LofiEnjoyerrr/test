...
from django.db.models import Prefetch, Q, Subquery, OuterRef, F
from django.db.models.functions import Coalesce

from doctors.models import Doctor, Manipulation
...
def sync_manipulations_by_mkb(doctors_ids: Iterable[int]):
    ...
    """
    # Для всех переданных ID врачей берём мастера или его самого, если он - мастер
